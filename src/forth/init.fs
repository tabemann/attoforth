  ...
  0 ?DO
    ...
    DUP 2 PICK TERMINAL-WIDTH @ >= IF
      ...
      2 PICK TERMINAL-HEIGHT @ >= IF
        ...
        9999 0 GO-TO-COORD
        2 PICK TERMINAL-INIT-ROW @ 1- DUP 0>= IF
          3 PICK TERMINAL-INIT-ROW !
        ELSE
          DROP 0 3 PICK TERMINAL-INIT-ROW !
          0 3 PICK TERMINAL-INIT-COLUMN !
        THEN
      ELSE
        OVER TERMINAL-ROW @ 1+
      THEN
  ...
  0 ?DO
    ...
    DUP 2 PICK TERMINAL-WIDTH @ >= IF
      ...
      DUP 3 PICK TERMINAL-HEIGHT @ >= IF
        ...
        OVER TERMINAL-INIT-ROW @ 1- DUP 0>= IF
          2 PICK TERMINAL-INIT-ROW !
        ELSE
          DROP 0 2 PICK TERMINAL-INIT-ROW !
          0 2 PICK TERMINAL-INIT-COLUMN !
        THEN
      THEN
...
: HANDLE-YANK ( source -- )
  ...
  DUP TERMINAL-KILL-RING-LAST @ 0<> IF
    ...
    2 PICK LAST-KILL-ENTRY-DATA-SIZE @ + 2 PICK LAST-KILL-ENTRY-DATA-SIZE @ MOVE
