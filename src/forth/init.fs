...
: PRINT-YANK-PREV ( source -- )
  DUP LAST-KILL-ENTRY-SIZE @ OVER SWAP GO-BACKWARD
  DUP DUP LAST-KILL-ENTRY-SIZE @ NEGATE PRINT-OFFSET
...
: HANDLE-YANK-PREV ( source -- )
  DUP TERMINAL-PREV-COMMAND-TYPE @ YANK-COMMAND = IF
    ...
    DUP 2 PICK TERMINAL-INSERT-OFFSET @ + OVER TERMINAL-INSERT-OFFSET !
    PRINT-YANK-PREV
  ELSE
    DROP
  THEN ;
